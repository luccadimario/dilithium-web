...
const phases = [
  ...
  },
  {
    ...
    status: 'done' as const,
    items: [
      { label: 'Seed node infrastructure & DNS seeds' },
      { label: 'Block explorer' },
      { label: 'Improved peer discovery & scoring' },
      ...
      { label: 'Mining pool support (Stratum V1)' },
      { label: 'GPU mining with CUDA' },
    ] as PhaseItem[],
  },
  {
    phase: 'Phase 3',
    ...
    items: [
      ...
      { label: 'Merkle tree block verification', done: true },
      { label: 'Web miner (WASM)', done: true },
